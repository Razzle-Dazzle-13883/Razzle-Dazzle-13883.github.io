  ...
  return (
    <header className="sticky top-0 z-50">
      <motion.div
        ...
        className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#372a2f] px-6 md:px-10 py-3 bg-[#171214]/95 backdrop-blur-sm"
      >
      ...
      <motion.nav
        ...
        className="md:hidden fixed top-[65px] right-0 bottom-0 w-64 bg-[#171214] border-l border-[#372a2f] p-6 z-40"
      >
          ...
          {navLinks.map((link, index) => (
            ...
            >
              <Link
                ...
                className={`text-lg font-medium ${pathname === link.href ? 'text-[#db3d7a]' : 'text-white'
                  }`}
              >
                {link.label}
              </Link>
